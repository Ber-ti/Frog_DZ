...
# Использование '%'
result1 = "В команде 'Мастера кода' участников: %.f !" % team1_num
result2 = "Итого сегодня в командах участников: %.f и %.f" % (team1_num, team2_num)

# Использование format()
result3 = "Команда Волшебники данных решила задач: {} !".format(score2)
result4 = "Волшебники данных решили задачи за {}c!".format(team1_time)

# Использование f-строк
result5 = f"Команды решили {score1} и {score2} задач!"
result6 = f"Результат битвы: {challenge_result}"
result7 = f"Сегодня было решено {tasks_total} задач в среднем по {time_avg} секунд на задачу"
